...
- ✅ 크레딧 시스템 및 백프레셔 메커니즘
- ✅ Port Manager 설계 (Ingress/Egress)
- ✅ Port Router 설계 (큐 매니져)
- ✅ 패킷 Stitching Flow (6단계 프로세스)
- ✅ Entry ID 기반 메모리 관리
- ✅ AXIS Fabric 인터페이스

### **핵심 인터페이스**
- **AXIS Protocol**: TVALID, TREADY, TDATA, TLAST 신호 사용
- **Port Manager ↔ Port Router**: AXIS P2P 연결
- **Port Manager ↔ 외부**: AXIS 인터페이스
